...
app.use(cors({
  origin: ['https://hfcsundayschool.vercel.app','http://localhost:3000','http://localhost:5173','https://jeevan-bay.vercel.app','https://sundayschool-one.vercel.app','http://localhost:3001'], // Replace with your frontend URL
  credentials: true,
