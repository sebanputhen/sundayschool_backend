...
router.get('/family-mismatches', getFamilyMismatchRecords);
router.get('/family-mismatches/summary', getFamilyMismatchSummary);
//router.post('/family-mismatches/fix', fixFamilyMismatches);
// ========================================
